...
| 5 | Check for updates on the 200 OK / soft-delete blocker | AITAPA | after 2pm | not started |
| 6 | Confirm subnet-error status | AITAPA | after 2pm | not started |
| 7 | Phase-2 review + coordinate with Timothy McDonald | AITAPA | after 2pm | not started |
| 8 | Confirm whether the 07/21 Workspace call happened | AITAPA | after 2pm | not started |
| 9 | (ad hoc, AITAPC) Fix workbench issue in i0001 for Pooja | AITAPC | TBD | not started — check first whether this is the same image-registry-lifecycle-policy root cause resolved yesterday (i0001/d0004) |
